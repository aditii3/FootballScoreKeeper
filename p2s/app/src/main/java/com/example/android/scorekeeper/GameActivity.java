...
//          setting resource id's
        imgIdol1 = findViewById(R.id.idol_1);
        imgIdol2 = findViewById(R.id.idol_2);
        imgPlay2 = findViewById(R.id.play_2);
        imgPlay1 = findViewById(R.id.play_1);
        b1Goal = findViewById(R.id.btn_goal_1);
        b2Goal = findViewById(R.id.btn_goal_2);
        b1Touch = findViewById(R.id.btn_touch_1);
        b2Touch = findViewById(R.id.btn_touch_2);
        b1Extra = findViewById(R.id.btn_extra_1);
        b2Extra = findViewById(R.id.btn_extra_2);
        b1Foul = findViewById(R.id.btn_foul_1);
        b2Foul = findViewById(R.id.btn_foul_2);
        b1Safety = findViewById(R.id.btn_safety_1);
        b2Safety = findViewById(R.id.btn_safety_2);
        resetButton = findViewById(R.id.reset_button);
        timer = (TextView) findViewById(R.id.timer);
        teamA = findViewById(R.id.score_team_1);
        teamB = findViewById(R.id.score_team_2);
        setTimer(time * 60000);
        updateA();
        updateB();
        updates(time);
    ...
    private void updateA() {
        ...
        teamA.setText(String.format(r.getString(R.string.update_score), nameA, score1, foul1, dwn1, extra1, goal1));
    }

    private void updateB() {
        Resources r = getResources();
        teamB.setText(String.format(r.getString(R.string.update_score), nameB, score2, foul2, dwn2, extra2, goal2));
    }
    ...
    private void updates(long time) {
        b = new CountDownTimer(time * 60000, 15000) {
            ...
            public void onTick(long millisUntilFinished) {
                if (score1 - score2 == 1) {
                    Toast.makeText(GameActivity.this, "Buck up " + nameB + " ONE MORE TO GO!!!", Toast.LENGTH_SHORT).show();
                } else if (score2 - score1 == 1) {
                    Toast.makeText(GameActivity.this, "Buck up " + nameA + " ONE MORE TO GO!!!", Toast.LENGTH_SHORT).show();
                } else if (score1 == score2) {
                    (Toast.makeText(GameActivity.this, "GAME IS ON!!", Toast.LENGTH_SHORT)).show();
                } else if (score1 > score2) {
                    Toast.makeText(GameActivity.this, nameA + " ahead by " + (score1 - score2), Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(GameActivity.this, nameB + " ahead by " + (score2 - score1), Toast.LENGTH_SHORT).show();
                }
            }
